...
ActiveRecord::Schema.define(version: 2018_09_02_164318) do
  ...
  create_table "inventions", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_inventions_on_user_id"
  end

  create_table "inventions_materials", id: false, force: :cascade do |t|
    t.integer "invention_id"
